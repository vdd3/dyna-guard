...
public class DynamicValidationException extends RuntimeException {
     ...
     */
    public DynamicValidationException(String errorCode, String errorMessage) {
     ...
     * @param cause        异常
     */
    public DynamicValidationException(String errorCode, String errorMessage, Throwable cause) {
     ...
     */
    public DynamicValidationException(String errorCode,
                                      String errorMessage,
